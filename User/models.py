...
class Player(models.Model):
    ...
    provide = models.CharField(verbose_name='จังหวัด', max_length=50 ,blank=True , null = True)
    address = models.CharField(verbose_name='ที่อยู่', max_length=255 ,blank=True , null = True)
